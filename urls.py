...
# Helper function for adding url rules to the application.  
# Any url answered by the application has to be mapped to a view function here.
# app: The Flask app running the application
def add_urls(app):
    ...
    app.add_url_rule('/api/', view_func=views.API.as_view('api'))